...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTHORIZED_REQUESTS_ANYBODY = new String[]{"/", "/registration", "/css/**", "/images/**", "/js/**", "/catalogue", "/registration", "/error", "/contact", "/compte", "/panier", "/articles"};
