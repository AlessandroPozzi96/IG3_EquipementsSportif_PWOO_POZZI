...
<c:set var="contextPath" value="${pageContext.request.contextPath}"/>
    ...
    <security:authorize access="isAnonymous()">
        <p class="lead"><a href='<spring:url value="/login"/>'>Connectez-vous </a> pour passer commande !</p>
        <p class="lead">Ou <a href='<spring:url value="/registration"/>'>enregistrez-vous </a> si ce n'est pas déjà fait !</p>
    </security:authorize>
