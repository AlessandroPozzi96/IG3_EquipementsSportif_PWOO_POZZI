...
<form:form id="formUser"
    ...
    <div class="form-group">
        ...
        <form:input type="text" path="username" class="form-control" placeholder="Enter your email adress"
    ...
    <div class="form-group">
        ...
        <form:input type="tel" path="numTelephone" size="13" minLength="9" maxLength="14"  class="form-control"
                    placeholder="[Not mandtory] Enter your phone number ex : 0475118526"></form:input>
